...
struct InterfacialResponseFunction {
    ...
    KOKKOS_INLINE_FUNCTION
    int getPreferredPhaseNucleation(const float loc_u) const {
    ...
    KOKKOS_INLINE_FUNCTION
    int getPreferredPhaseActivation(const int local_phase_id) const {
    ...
    auto numPhases() { return _inputs.num_phases; }
