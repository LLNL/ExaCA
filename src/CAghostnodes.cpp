...
void GhostNodesInit_GPU(int, int, int DecompositionStrategy, int MyLeft, int MyRight, int MyIn, int MyOut, int MyLeftIn,
                        ...
                        ViewI NeighborX, ViewI NeighborY, ViewI NeighborZ, ViewF GrainUnitVector,
...
void GhostNodes2D_GPU(int, int, int MyLeft, int MyRight, int MyIn, int MyOut, int MyLeftIn, int MyRightIn,
...
void GhostNodes1D_GPU(int, int, int MyLeft, int MyRight, int MyXSlices, int MyYSlices, int MyXOffset, int MyYOffset,
                      ViewI NeighborX, ViewI NeighborY, ViewI NeighborZ, ViewI CellType, ViewF DOCenter, ViewI GrainID,
                      ViewF GrainUnitVector, ViewI GrainOrientation, ViewF DiagonalLength, ViewF CritDiagonalLength,
