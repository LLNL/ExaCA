...
void OrientationInit(int id, int NGrainOrientations, ViewI::host_mirror_type GrainOrientation, ViewF::host_mirror_type GrainUnitVector, string GrainOrientationFile) {
