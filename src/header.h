...
void SubstrateInit_ConstrainedGrowth(double FractSurfaceSitesActive, int MyXSlices, int MyYSlices, int nz, int MyXOffset, int MyYOffset, int pid, int np, ViewI_H CellType, ViewI_H GrainID);
...
void SubstrateInit_FromGrainSpacing(float SubstrateGrainSpacing, int nx, int ny, int nz, int nzActive, int MyXSlices, int MyYSlices, int MyXOffset, int MyYOffset, int pid, int np, double deltax, ViewI GrainID_DEVICE, ViewI_H GrainID_HOST, ViewI_H CritTimeStep);
