...
void ActiveCellInit(int id, int MyXSlices, int MyYSlices, int nz, ViewI_H CellType, ViewI_H CritTimeStep, ViewI_H NeighborX, ViewI_H NeighborY, ViewI_H NeighborZ);
