...
int main(int argc, char *argv[]) {
    ...
    PrintInversePoleFigureCrossSections(NumberOfCrossSections, BaseFileName, CrossSectionPlane, CrossSectionLocation,
                                        nx, ny, nz, NumberOfOrientations, GrainID, GrainEulerAngles);
    ...
    PrintMisorientationData(AnalysisTypes, BaseFileName, XMin, XMax, YMin, YMax, ZMin, ZMax, Melted, GrainUnitVector,
                            GrainID, NumberOfOrientations);
    ...
    PrintPoleFigureData(AnalysisTypes, BaseFileName, NumberOfOrientations, GrainEulerAngles, XMin, XMax, YMin, YMax,
                        ZMin, ZMax, GrainID, Melted);
