...
void testReadTemperatureData() {
    ...
    ViewI_H MaxSolidificationEvents_H(Kokkos::ViewAllocateWithoutInitializing("MaxSolidificationEvents"), NumberOfLayers);
    ...
    ReadTemperatureData(id, false, MaxSolidificationEvents_H, MyXSlices, MyYSlices, MyXOffset, MyYOffset, deltax, HT_deltax, nx, ny, XMin, YMin, temp_paths, FreezingRange, LayerHeight,
