            ...
            for (int j = 0; j < MyYSlices; j++) {
                ...
                if (i + k <= 5) {
                    ...
                    if ((k >= ZBound_Low) && (k <= ZBound_High)) {
                        ...
                        EXPECT_FLOAT_EQ(CritDiagonalLength_Host(26 * D3D1ConvPosition), 1.7009771);
                        EXPECT_FLOAT_EQ(CritDiagonalLength_Host(26 * D3D1ConvPosition + 1), 2.1710062);
                        EXPECT_FLOAT_EQ(CritDiagonalLength_Host(26 * D3D1ConvPosition + 2), 1.9409304);
                        EXPECT_FLOAT_EQ(CritDiagonalLength_Host(26 * D3D1ConvPosition + 3), 1.9225504);
                        EXPECT_FLOAT_EQ(CritDiagonalLength_Host(26 * D3D1ConvPosition + 4), 2.2444904);
                        EXPECT_FLOAT_EQ(CritDiagonalLength_Host(26 * D3D1ConvPosition + 5), 2.6762383);
                        EXPECT_FLOAT_EQ(CritDiagonalLength_Host(26 * D3D1ConvPosition + 6), 2.7775407);
                        EXPECT_FLOAT_EQ(CritDiagonalLength_Host(26 * D3D1ConvPosition + 7), 2.6560771);
                        EXPECT_FLOAT_EQ(CritDiagonalLength_Host(26 * D3D1ConvPosition + 8), 2.1579251);
                        EXPECT_FLOAT_EQ(CritDiagonalLength_Host(26 * D3D1ConvPosition + 9), 1.5170407);
                        EXPECT_FLOAT_EQ(CritDiagonalLength_Host(26 * D3D1ConvPosition + 10), 1.5170407);
                        EXPECT_FLOAT_EQ(CritDiagonalLength_Host(26 * D3D1ConvPosition + 11), 2.0631697);
                        EXPECT_FLOAT_EQ(CritDiagonalLength_Host(26 * D3D1ConvPosition + 12), 2.4170816);
                        EXPECT_FLOAT_EQ(CritDiagonalLength_Host(26 * D3D1ConvPosition + 13), 2.4170816);
                        EXPECT_FLOAT_EQ(CritDiagonalLength_Host(26 * D3D1ConvPosition + 14), 2.0631697);
                        EXPECT_FLOAT_EQ(CritDiagonalLength_Host(26 * D3D1ConvPosition + 15), 1.4566354);
                        EXPECT_FLOAT_EQ(CritDiagonalLength_Host(26 * D3D1ConvPosition + 16), 1.4566354);
                        EXPECT_FLOAT_EQ(CritDiagonalLength_Host(26 * D3D1ConvPosition + 17), 1.7009771);
                        EXPECT_FLOAT_EQ(CritDiagonalLength_Host(26 * D3D1ConvPosition + 18), 1.9409304);
                        EXPECT_FLOAT_EQ(CritDiagonalLength_Host(26 * D3D1ConvPosition + 19), 2.1710062);
                        EXPECT_FLOAT_EQ(CritDiagonalLength_Host(26 * D3D1ConvPosition + 20), 2.2444904);
                        EXPECT_FLOAT_EQ(CritDiagonalLength_Host(26 * D3D1ConvPosition + 21), 1.9225504);
                        EXPECT_FLOAT_EQ(CritDiagonalLength_Host(26 * D3D1ConvPosition + 22), 2.6560771);
                        EXPECT_FLOAT_EQ(CritDiagonalLength_Host(26 * D3D1ConvPosition + 23), 2.1579251);
                        EXPECT_FLOAT_EQ(CritDiagonalLength_Host(26 * D3D1ConvPosition + 24), 2.6762383);
                        EXPECT_FLOAT_EQ(CritDiagonalLength_Host(26 * D3D1ConvPosition + 25), 2.7775407);
                    }
                }
                else {
...
void testNucleiInit() {
    ...
    int PossibleNuclei_ThisRankThisLayer;
