...
void testSubstrateInit_FromGrainSpacing() {
    ...
    // The cells at Z = 4 are outside the "active" portion of the domain and are not assigned Grain IDs with the rest of the baseplate
    ...
    if (id % 2 == 0) {
        // Expected GrainID values for the baseplate grains (should be values 1-6)
