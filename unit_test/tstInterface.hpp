...
void testHaloUpdate() {
    ...
    grid.bottom_of_current_layer = grid.nx * grid.ny_local * grid.z_layer_bottom;
    grid.top_of_current_layer = grid.nx * grid.ny_local * grid.z_layer_bottom + grid.domain_size;
