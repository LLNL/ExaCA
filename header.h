...
typedef Kokkos::View <float*,Kokkos::CudaUVMSpace> ViewBuf;
typedef Kokkos::View <int*,Kokkos::CudaUVMSpace> ViewBufCounts;

// Called from "main_main.cpp"
void RunProgram_Reduced(int pid, int np, int ierr, int DecompositionStrategy, double deltax, double AConst, double BConst, double CConst, double NMax, double dTN, double dTsigma, string BaseFileName, string GrainOrientationFile, string TemperatureDataType);
...
void PrintValues(int pid, int np,int nx, int ny,int nz, int MyXSlices, int MyYSlices, int ProcessorsInXDirection, int ProcessorsInYDirection, ViewI::HostMirror GrainID, int* GrainOrientation,float* GrainUnitVector,string BaseFileName, int DecompositionStrategy, int NGrainOrientations, bool* Melted);
